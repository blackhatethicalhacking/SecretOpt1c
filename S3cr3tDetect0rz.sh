...
echo "This Report is generated by S3cr3tDetect0rz from www.blackhatethicalhacking.com" > "$domain/secrets.csv"
echo "The date is: $(date)" >> "$domain/secrets.csv"
echo "" >> "$domain/secrets.csv"
echo "" >> "$domain/secrets.csv"
